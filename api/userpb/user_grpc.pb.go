...
type UserClient interface {
	Create(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserId, error)
...
func (c *userClient) Create(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserId, error) {
...
func (c *userClient) Delete(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type UserServer interface {
	Create(context.Context, *CreateUserRequest) (*UserId, error)
...
func (UnimplementedUserServer) Create(context.Context, *CreateUserRequest) (*UserId, error) {
...
func (UnimplementedUserServer) Delete(context.Context, *UserId) (*emptypb.Empty, error) {
...
func _User_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Delete(ctx, req.(*UserId))
	}
	return interceptor(ctx, in, info, handler)
}
